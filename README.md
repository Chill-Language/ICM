...
# How To Build
At first, you shold add library what names 'Chill's Basic Library' from my GitHub, then, run 'compile.bat' for Windows or run 'compile.sh' on Linux. (To use **GCC**.)<br>
